<template>
  <div class="macbook-air">
    <div class="div">
      ...
      <router-link to="/buatakun" class="text-wrapper-3">Buat Akun</router-link>
      <div class="group">
        <div class="text-wrapper-4">Welcome Back</div>
        <div class="text-wrapper-5">Masukkan Nama dan Password</div>
        <router-link to="/home" class="overlap">
          <Google class="google-instance" />
          <div class="text-wrapper-6">Login Dengan Google</div>
        </router-link>
        <router-link to="/home" class="overlap-group">
          <div class="text-wrapper-7">Login Dengan Apple</div>
...
input {
  ...
  background-color: transparent; /* Untuk menghilangkan warna background bawaan */
}
